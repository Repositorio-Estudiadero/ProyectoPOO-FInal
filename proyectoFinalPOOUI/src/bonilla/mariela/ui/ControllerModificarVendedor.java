...
import bonilla.mariela.tl.ControllerVendedor;
...
public class ControllerModificarVendedor implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        select_fecha.setValue(login.getFechaNacimiento());
    ...
    public void modificarUsuario(ActionEvent event) throws IOException, SQLException {
        ...
        if(validarEspacios()) {
            ...
            if (correoRepetido) {
                ...
                ctUsuario.modificarVendedor(text_nombre.getText(),
