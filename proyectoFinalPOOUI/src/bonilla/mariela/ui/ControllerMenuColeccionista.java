...
public class ControllerMenuColeccionista implements Initializable {
    ...
    private void irRegistrarSubasta(MouseEvent event) throws IOException {
        System.out.println("registrar subasta");

        Stage escenaPrincipal = (Stage)((Node) event.getSource()).getScene().getWindow();

        System.out.println("Ingresa al formulario de registrar subasta");
        Parent ruta = FXMLLoader.load(getClass().getResource("registrar_subasta_coleccionista.fxml"));
    ...
    private void irMisSubastas(MouseEvent event) throws IOException {
        ...
        Parent ruta = FXMLLoader.load(getClass().getResource("mis_subastas_coleccionista.fxml"));
    ...
    @FXML
    private void irRegistrarItem(MouseEvent event) throws IOException {
        Stage escenaPrincipal = (Stage)((Node) event.getSource()).getScene().getWindow();
    ...
    @FXML
    private void irMisItems(MouseEvent event) throws IOException {
        Stage escenaPrincipal = (Stage)((Node) event.getSource()).getScene().getWindow();
    ...
    @FXML
    private void irRegistrarOferta(MouseEvent event) throws IOException {
        Stage escenaPrincipal = (Stage)((Node) event.getSource()).getScene().getWindow();
    ...
    @FXML
    private void irAdjudicacionesPendientes(MouseEvent event) throws IOException {
        Stage escenaPrincipal = (Stage)((Node) event.getSource()).getScene().getWindow();
        Parent ruta = FXMLLoader.load(getClass().getResource("adjudicaciones_pendientes.fxml"));
    ...
    private void modificarUsuario(MouseEvent event) throws IOException {
        ...
        Parent ruta = FXMLLoader.load(getClass().getResource("modificar_coleccionista.fxml"));
